...
while (dpl<Final_dpl):
  ...
  while (y<Final_y):
    ...
    callString="../adda -size 2 -dpl "+str(dpl)+" -lambda 1 -prop 0 0 1 -beam barton5 1 "+str(x)+" "+str(y)+" "+str(z)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
    print("../adda -size 2 -dpl "+str(dpl)+" -lambda 1 -prop 0 0 1 -beam barton5 1 "+str(x)+" "+str(y)+" "+str(z)+" -store_beam -store_dip_pol -store_int_field")
