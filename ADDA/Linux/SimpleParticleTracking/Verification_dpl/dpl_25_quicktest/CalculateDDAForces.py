...
while (y<Final_y):
  ...
  callString="../adda -size 2 -dpl 25 -lambda 1 -prop 0 0 1 -beam barton5 1 "+str(x)+" "+str(y)+" "+str(z)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
