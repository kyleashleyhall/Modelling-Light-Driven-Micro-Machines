...
while (dpl<Final_dpl):
    while (x<(Final_x+Step_x)):
        ...
        while (y<(Final_y+Step_y)):
            ...
            callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read propellorfile -lambda 1.064 -m 1.183390347 0 -prop 0 0 1 -orient "+str(alpha)+" 0 0 -beam barton5 "+str(BeamWidth)+" "+str(-x)+" "+str(-y)+" "+str(z)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
            print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read propellorfile -lambda 1.064 -m 1.183390347 0 -prop 0 0 1 -orient "+str(alpha)+" 0 0 -beam barton5 "+str(BeamWidth)+" "+str(-x)+" "+str(-y)+" "+str(z)+" -store_beam -store_dip_pol -store_int_field")
