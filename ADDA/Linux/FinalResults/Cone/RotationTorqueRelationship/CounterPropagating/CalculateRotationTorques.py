...
while (dpl<Final_dpl):
    ...
    while (alpha<(Final_alpha+Step_alpha)):
        ...
        callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read conefile -lambda 1.064 -prop 0 0 1 -m 1.183390347 0 -beam barton5 "+str(BeamWidth)+" "+str(x_beam1)+" "+str(y_beam1)+" "+str(z_beam1)+" -store_beam" #The script for performing the DDA calculations
        ...
        callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read conefile -lambda 1.064 -prop 0 0 -1 -m 1.183390347 0 -beam barton5 "+str(BeamWidth)+" "+str(x_beam2)+" "+str(y_beam2)+" "+str(z_beam2)+" -store_beam" #The script for performing the DDA calculations
        subprocess.call(callString,shell=True)
        ...
        callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read conefile -lambda 1.064 -prop 0 0 1 -m 1.183390347 0 -sym enf -beam read DualBeam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
        print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read conefile -lambda 1.064 -prop 0 0 1 -m 1.183390347 0 -sym enf -beam read DualBeam -store_dip_pol -store_int_field")
