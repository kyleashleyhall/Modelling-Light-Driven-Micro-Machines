...
TitleString=r"Torque at counter propagating beam focus"

ax = plt.gca()
SpherePlot = np.transpose(np.loadtxt('..\..\..\Sphere\RotationTorqueRelationship\CounterPropagating\Torques'))
SphereForcePlot=plt.errorbar(SpherePlot[0], SpherePlot[1],label="Sphere")
ConePlot = np.transpose(np.loadtxt('..\..\..\Cone\RotationTorqueRelationship\CounterPropagating\Torques'))
ConeForcePlot=plt.errorbar(ConePlot[0], ConePlot[1],label="Cone")
PropellerPlot = np.transpose(np.loadtxt('..\..\..\Propeller\RotationTorqueRelationship\CounterPropagating\Torques'))
