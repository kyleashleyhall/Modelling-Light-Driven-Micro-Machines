...
while arbvalue == 0: 
    ...
    Brownian_x_position = 0
    Brownian_x_positionsquare = 0
...
while t_0 <= t_end:
    ...
    callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size "+str(particleDiameterValue)+" -grid 30 -m "+str(refractiveIndexValue)+" 0 -lambda "+str(lambdaValue)+" -prop 0 0 1 -beam barton5 "+str(BeamWidth)+" "+str(x_beam)+" "+str(y_beam)+" "+str(z_beam)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
    print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size "+str(particleDiameterValue)+" -grid 30 -m "+str(refractiveIndexValue)+" 0 -lambda "+str(lambdaValue)+" -prop 0 0 1 -beam barton5 "+str(BeamWidth)+" "+str(x_beam)+" "+str(y_beam)+" "+str(z_beam)+" -store_beam -store_dip_pol -store_int_field")
