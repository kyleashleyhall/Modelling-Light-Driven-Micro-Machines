# -*- coding: utf-8 -*-
"""
Created on Fri Mar 23 18:48:01 2018
...
Force = np.transpose(np.loadtxt('ForcesY'))
...
while t_0 <= t_end:
    Force_y = Force[2,np.argmin(np.abs(y_position - Force[0]))]
    ...
    PositionArray = np.append(PositionArray, np.array([[t_0], [y_position], [Brownian]]), axis=1)
