...
x_beam1, y_beam1, z_beam1 = 0,0.25,0

#Start point of beam 2
x_beam2, y_beam2, z_beam2 = 0,0.75,0
...
while y_0 <= y_end:
    ...
    PPositionArray = np.append(PPositionArray, np.array([[y_0,EstimatedParticleForce3[0],EstimatedParticleForce3[1],EstimatedParticleForce3[2]]]),axis=0)
