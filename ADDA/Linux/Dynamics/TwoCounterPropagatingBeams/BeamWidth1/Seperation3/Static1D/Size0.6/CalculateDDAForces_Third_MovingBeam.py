...
x_position, y_position, z_position = 0,y_0,0
...
while y_0 <= y_end:
    ...
    PotentialArray = np.append(PotentialArray, np.array([[y_0,EstimatedParticleForce3[0],EstimatedParticleForce3[1],EstimatedParticleForce3[2]]]),axis=0)
