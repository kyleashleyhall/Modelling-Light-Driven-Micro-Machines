...
while (dpl<Final_dpl):
    while (z<Final_z):
        ...
        callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -dpl "+str(dpl)+" -lambda 0.9 -m 1.1859519224 0 -prop 0 0 1 -beam barton5 0.1 "+str(x)+" "+str(y)+" "+str(-z)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
        print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -dpl "+str(dpl)+" -lambda 0.9 -m 1.1859519224 0 -prop 0 0 1 -beam barton5 0.1 "+str(x)+" "+str(y)+" "+str(-z)+" -store_beam -store_dip_pol -store_int_field")
