...
while (dpl<Final_dpl):
    while (z<Final_z):
        ...
        callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size "+str(ParticleSize)+" -grid 30 -lambda 1.064 -m 1.183390347 0 -prop 0 0 1 -beam barton5 "+str(BeamWidth)+" "+str(x)+" "+str(y)+" "+str(-z)+" -store_beam -store_dip_pol -store_int_field" #The script for performing the DDA calculations
        print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size "+str(ParticleSize)+" -grid 30 -lambda 1.064 -m 1.183390347 0 -prop 0 0 1 -beam barton5 "+str(BeamWidth)+" "+str(x)+" "+str(y)+" "+str(-z)+" -store_beam -store_dip_pol -store_int_field")
