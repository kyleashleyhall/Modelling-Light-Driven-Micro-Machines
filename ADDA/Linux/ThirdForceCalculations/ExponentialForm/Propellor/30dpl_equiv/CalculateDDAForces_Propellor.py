...
while (dpl<Final_dpl):
    ...
    callString=".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -shape read propellorfile -m 1.5 0 -lambda 1 -prop 0 0 1 -store_beam -store_dip_pol -store_int_field -store_force" #The script for performing the DDA calculations
    print(".."+os.sep+"src"+os.sep+"seq"+os.sep+"adda -size 2 -dpl -shape read propellorfile -m 1.5 0 -lambda 1 -prop 0 0 1 -store_beam -store_dip_pol -store_int_field -store_force")
