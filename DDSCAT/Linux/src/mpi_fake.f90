! mpi_fake.f contains dummy subroutines that take the place of
!    SUBROUTINE COLSUM
!    SUBROUTINE SHARE0
!    SUBROUTINE SHARE1
!    SUBROUTINE SHARE2
...
! arguments
      ...
      INTEGER :: IANISO,IDVERR,IDVOUT,ILIN10,ILIN12,INIT,IOBIN,IORTH,   &
                 ...
                 NAT,NAT0,NAT3,NBETA,NBETH,NCOMP,NORI,NORICHAR,NPHI,    &
                 NRAD,NRFLD,NSCAT,NSMELTS,NTHETA,NWAV,NX,NY,NZ          !
      INTEGER*2 ::    &
         ICOMP(MXN3), &
         IOCC(MXNAT)  !
      INTEGER ::        &
...
!-----------------------------------------------------------------------
!*** diagnostic
!      write(0,*)'mpi_fake ckpt 1: CDESCR=',CDESCR
!      write(0,*)'              CFLEPS(1)=',CFLEPS(1)
!      write(0,*)'                 CMDFFT=',CMDFFT
!***
      RETURN
...
!=======================================================================
    ...
    SUBROUTINE MPI_BCAST_INT(IVAR1,IVAR2,IVAR3,IVAR4)
      IMPLICIT NONE
