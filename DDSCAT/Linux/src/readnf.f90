...
!          produced by DDSCAT v7.3.0 or v7.3.1
...
!                 e.g., 730 for version 7.3.0 or 731 for version 7.3.1
...
! 13.03.25 (BTD) v2 minor changes:
!                * CSTAMP,VERSNUM now read with one statement
!                * no longer read CXEINC and CXBINC from stored file,
!                  as they are readily reconstructed here
! 14.10.06 (BTD) * allow use of files created by version 7.3.1
! 17.01.25 (BTD) * allow use of files created by version 7.3.2
!                  add 732 to allowed values of VERSNUM
!                  [bug discovered by Joshua Graber]
! end history
!===============================================================================
...
!***
      IF(VERSNUM.EQ.730.OR.VERSNUM.EQ.731.OR.VERSNUM.EQ.732)THEN
!*** diagnostic
