...
! 15.03.06 (BTD) modify to remove ambiguity in directions of
!                axis vectors a_1 and a_2:
!                prevent negative value for a_1(1)
!                and negative value for a_2(2)
! End history.

! Copyright (C) 1993,1994,1995,1996,1997,1998,2000,2004,2007,2015
...
! 15.03.06 new code to eliminate ambiguity about choice of
!          direction for axis vectors a_1,a_2
! If A1(1)<0, reverse direction of a_1

      IF(A1(1)<0._WP)THEN
         WRITE(CMSGNM,FMT='(A)')' reverse eigenvector a_1'
...
! If A2(2)<0, reverse direction of a_2

      IF(A2(2)<0._WP)THEN
         WRITE(CMSGNM,FMT='(A)')' reverse eigenvector a_2'
         CALL WRIMSG('PRINAXIS',CMSGNM)
         DO K=1,3
            A2(K)=-A2(K)
         ENDDO
