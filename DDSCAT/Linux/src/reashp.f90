    SUBROUTINE REASHP(CSHAPE,CFLSHP,IDVOUT,IDVSHP,A1,A2,DX,X0,BETADF,PHIDF, &
                      THETADF,CDESCR,IOSHP,MXNAT,NAT,IXYZ,ICOMP,NAT3,       &
                      NCOMP_NEED)
...
! Arguments:
      ...
      INTEGER :: IDVOUT,IDVSHP,IOSHP,MXNAT,NAT,NAT3,NCOMP_NEED
...
!***********************************************************************
! Given:
!    CSHAPE = 'FROM_FILE' or 'FRMFILPBC' to read list of occupied sites
!                         and compositions from file -- use this for
!                         targets composed of isotropic materials or
!                         materials with optic axes aligned with Target
!                         Frame axes x_TF,y_TF,z_TF
!             'ANIFRMFIL' or 'ANIFILPBC' to read list of occupied sites,
!                         compositions, and orientations for anisotropic
!                         material from file -- use this for targets 
!                         composed of general isotropic materials
!                         dielectric tensor orientation for each dipole
!                         is specified by three angles ThetaDF,BetaDF,
!                         and PhiDF
...
! 14.10.27 (BTD): v4 (ver7.3.1)
!                 removed MXN3 from arg list
! end history
...
!***********************************************************************
!*** diagnostic
!      write(0,*)'reashp_v4 ckpt 0 mxnat=',mxnat
!***
