...
! 13.05.30 (BTD): small change in formatting of WRITE to CMSGNM
!                 I4 -> I7 to avoid overflow
! 14.10.31 (BTD): small change in format statement 9030 to allow
!                 one more digit fo IX,IY,IZ
! end history
...
! ASPR=aspect ratio (length/diameter)
      ...
      WRITE(CDESCR,FMT='(A,I7,A,I7,A,I7,A,F7.4)')' Cyl.prism, NAT=',NAT, &
