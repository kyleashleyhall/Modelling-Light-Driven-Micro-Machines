...
The convention for 1-d and 2-d targets is for target axes
a_1 in the x_TF direction
a_2 in the y_TF direction

The target orientation in the Lab Frame is set to

   BETA = 0 (no rotation arount a_1)
   THETA = 30 deg (radiation incident at 30 deg from x_TF)
